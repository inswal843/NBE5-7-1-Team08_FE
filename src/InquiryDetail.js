            ...
            <div className="card-body">
              <table className="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td colSpan={5}
                      style={{textAlign: "center"}}>{inquiry.title}</td>
                </tr>
                <tr>
                  <th style={{textAlign: "center"}}>질문</th>
                  <td colSpan={5}
                      style={{textAlign: "center"}}>{inquiry.question}</td>
                </tr>
                <tr>
                  ...
                  <td style={{textAlign: "center",whiteSpace: "nowrap"}}>{dayjs(
                      inquiry.createdAt).format('YYYY-MM-DD HH:mm')}</td>
                  <th style={{textAlign: "center",whiteSpace: "nowrap"}}>수정일</th>
                  <td style={{textAlign: "center",whiteSpace: "nowrap"}}>{dayjs(
                      inquiry.updatedAt).format('YYYY-MM-DD HH:mm')}</td>
                </tr>
                <tr>
                  <th style={{textAlign: "center"}}>답변</th>
                  <td colSpan={5} style={{textAlign: "center"}}>{inquiry.answer
                      || "아직 답변이 없습니다."}</td>
                </tr>
                </tbody>
              </table>
