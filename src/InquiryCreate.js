...
function InquiryCreate() {
  ...
  const handleSubmit = (e) => {
    ...
    .then((res) => {
      ...
      setAlertMessage("문의가 성공적으로 등록되었습니다!");  // 성공 시 알림
      navigate('/inq/page');
    })
    .catch((err) => {
      console.error("문의 등록 실패:", err);
      setAlertMessage("등록 실패!");  // 실패 시 알림
    });
  };
  ...
  return (
    <div style={{
      ...
      <div className="container">
        ...
        >
          <h1 className="m-0 mx-auto text-center" style={{flexGrow: 1}}>문의 등록</h1>
          <div className="d-flex align-items-center" style={{position: 'absolute', right: 0}}>
            <button className="btn btn-outline-secondary me-2"
                    onClick={() => navigate('/inq/page')}>문의 게시판</button>
